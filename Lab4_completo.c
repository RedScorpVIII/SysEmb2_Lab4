...
void mitimerA0 (void)
{
    ...
    GPIOPinWrite(GPIO_PORTN_BASE, 0x02, ~GPIOPinRead(GPIO_PORTN_BASE, 0x02));
...
int main(void)
{
    ...
    GPIOPinTypeGPIOOutput(GPIO_PORTN_BASE, 0x02);  // Configurar PN0 como salida para el LED
...
void mitimerA0(void)
{
    ...
    GPIOPinWrite(GPIO_PORTN_BASE, 0x03, 0);  // Apagar PN0 y PN1
    GPIOPinWrite(GPIO_PORTF_BASE, 0x11, 0);  // Apagar PF4 y PF0
